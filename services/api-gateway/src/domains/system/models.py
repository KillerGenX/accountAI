...
class WorkspaceModel(SystemBaseModel):
    ...
    timezone = Column(
        String, nullable=False, server_default="Asia/Jakarta", default="Asia/Jakarta"
    )
    ...
    # Relationships
    users = relationship(
        "UserModel", back_populates="workspace", cascade="all, delete-orphan"
    )
    employee_configs = relationship(
        "EmployeeConfigModel", back_populates="workspace", cascade="all, delete-orphan"
    )
    settings = relationship(
        "UserSettingsModel", back_populates="workspace", cascade="all, delete-orphan"
    )
...
class UserModel(SystemBaseModel):
    ...
    )  # administrator, account_manager, sales_manager
    status = Column(
